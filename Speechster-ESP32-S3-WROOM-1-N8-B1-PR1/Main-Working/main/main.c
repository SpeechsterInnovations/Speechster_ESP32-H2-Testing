...
#define FSR_ADC_CHANNEL      ADC_CHANNEL_3
...
void app_main(void) {
    ...
    // Start Tasks
    xTaskCreatePinnedToCore(i2s_capture_task, "i2s_cap", 16*1024, NULL, 4, NULL, 1);
    xTaskCreatePinnedToCore(pSensor_task, "pSensor", 4*1024, NULL, 3, NULL, 1);
    xTaskCreatePinnedToCore(ble_sender_task, "ble_send", 24*1024, NULL, 5, NULL, 0);
    xTaskCreatePinnedToCore(telemetry_task, "telemetry", 4096, NULL, 1, NULL, 1);
