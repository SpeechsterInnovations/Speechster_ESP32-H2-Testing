...
#define CHAR_RX_UUID        "feed0001-0010-0000-8000-00805f9b34fb" // Write from web
#define CHAR_TX_UUID        "feed0002-0010-0000-8000-00805f9b34fb" // Notify to web

static int on_write(uint16_t conn_handle, uint16_t attr_handle,
                    struct ble_gatt_access_ctxt *ctxt, void *arg) {
    ESP_LOGI(TAG, "Data written from Web Bluetooth: %.*s",
